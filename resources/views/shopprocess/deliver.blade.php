        ...
        <form action="{{ route('shopStoreDeliver') }}" method="POST">
            ...
            <div class="container border p-4 mb-4">
                <div class="container d-flex flex-column p-0 m-0">
                    <input name="name" class="w-100 mb-3" type="text" placeholder="收件者姓名" required>
                    <input name="address" class="w-100 mb-3" type="text" placeholder="收件者地址" required>
                    <input name="date" class="w-100 mb-3" type="date" required>
                    <input name="phone" class="w-100 mb-3" type="number" placeholder="收貨者連絡電話" required>
                    <input name="menu" class="w-100" type="text" placeholder="備註">
                </div>
            </div>
